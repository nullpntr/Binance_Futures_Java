...
public interface SyncRequestClient {
    ...
    static SyncRequestClient createCoinM() {
        return createCoinM("", "", new RequestOptions());
    }

    static SyncRequestClient createCoinM(String apiKey, String secretKey) {
        return BinanceApiInternalFactory.getInstance().createCoinMSyncRequestClient(apiKey, secretKey, new RequestOptions());
    }

    static SyncRequestClient createCoinM(String apiKey, String secretKey, RequestOptions options) {
        return BinanceApiInternalFactory.getInstance().createCoinMSyncRequestClient(apiKey, secretKey, options);
    }
